...
@InputType()
class AdvertisementCreateNestedManyWithoutUsersInput {
...
export { AdvertisementCreateNestedManyWithoutUsersInput as AdvertisementCreateNestedManyWithoutUsersInput };
