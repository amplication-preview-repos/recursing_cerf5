...
import { MatrimonialProfile } from "../../matrimonialProfile/base/MatrimonialProfile";
...
export class UserResolverBase {
  ...
  async createUser(@graphql.Args() args: CreateUserArgs): Promise<User> {
    return await this.service.createUser({
      ...
      data: {
        ...
        familyMember: args.data.familyMember
          ? {
              connect: args.data.familyMember,
            }
          : undefined,

        matrimonialProfile: args.data.matrimonialProfile
          ? {
              connect: args.data.matrimonialProfile,
            }
          : undefined,
      },
    });
  ...
  async getFamilyMember(
    ...
    const result = await this.service.getFamilyMember(parent.id);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => MatrimonialProfile, {
    nullable: true,
  ...
  async getMatrimonialProfile(
    ...
    const result = await this.service.getMatrimonialProfile(parent.id);
